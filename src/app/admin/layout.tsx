...
export const metadata: Metadata = {
  title: "Admin",
  description: "Manage Stay Victoria listings, bookings, and availability.",
};
      ...
      <div className="mx-auto grid min-h-screen max-w-[1600px] lg:grid-cols-[260px_1fr]">
        <aside className="hidden border-r border-[#dfe2da] bg-[#173a33] px-5 py-7 text-white lg:flex lg:flex-col">
          <Link href="/admin" className="flex items-center gap-3 px-2">
            <span className="grid size-10 place-items-center rounded-2xl bg-[#d9ff75] text-lg font-bold text-[#173a33]">
              S
            </span>
            <span>
          ...
          <div className="mt-auto rounded-2xl bg-white/8 p-4 text-sm text-white/70">
            <p className="font-medium text-white">Guest website</p>
            <p className="mt-1 text-xs leading-5">Preview live listing and availability changes.</p>
            <Link href="/" className="mt-3 inline-flex font-medium text-[#d9ff75]">
              Open website ↗
            </Link>
          </div>
        </aside>
        ...
        <div className="min-w-0">
          <header className="sticky top-0 z-40 border-b border-[#dfe2da] bg-[#f5f5f1]/95 px-4 py-3 backdrop-blur lg:hidden">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/" className="text-sm font-medium text-[#365f55]">
                Guest site ↗
              </Link>
            </div>
